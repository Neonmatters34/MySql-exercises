INSERT INTO albums(artist, name, genre, release_date, sales)
VALUES ('Pink Floyd', 'The Dark Side of the Moon', 'Progressive Rock', 1973, 24.20),
  ...
  ('Bee Gees / Various artists',	'Saturday Night Fever',	'Disco',	1977, 20.6 ),
